        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2">
              <div className="flex h-10 w-10 items-center justify-center rounded-card bg-white/15">
              ...
              <div>
                <p className="font-display text-sm font-bold">Watauga County</p>
                <p className="text-xs text-white/70">Economic Development</p>
              </div>
            </div>
            <p className="mt-4 text-sm leading-relaxed text-white/70">
              Where Mountains Meet Innovation. Discover economic opportunities in North Carolina&apos;s High Country.
            </p>
